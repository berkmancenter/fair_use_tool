...
ActiveRecord::Schema.define(:version => 20100707200041) do

  create_table "answer_versions", :force => true do |t|
    t.integer  "answer_id"
    t.integer  "version"
    t.string   "content"
  ...
  create_table "case_answer_versions", :force => true do |t|
  ...
  create_table "user_answer_versions", :force => true do |t|
